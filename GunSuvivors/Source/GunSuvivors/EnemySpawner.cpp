...
void AEnemySpawner::BeginPlay()
{
	...
	if (GameMode)
	{
		MyGameMode = Cast<AGunSuvivorsGameMode>(GameMode);
		check(MyGameMode);
	}
...
{
	GetWorldTimerManager().SetTimer(SpawnTimer, this, &AEnemySpawner::OnSpawnTimerTimeout,
...
void AEnemySpawner::SpawnEnemy()
{
	...
	RandomPosition.Normalize(); // Normalize = (1, 1) 
...
{
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::White, TEXT("Enemy died"));
